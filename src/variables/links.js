...
const test = "https://discord.com/api/oauth2/authorize?client_id=${clientId}&redirect_uri=${redirectUri}/auth&response_type=code&scope=guilds%20identify&prompt=consent&state=${state}"
